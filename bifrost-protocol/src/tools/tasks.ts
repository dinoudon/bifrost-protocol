...
/**
 * Optimized task retrieval that offloads skill filtering to the SQLite layer.
 * Using json_each and EXISTS is significantly faster than parsing and filtering in JS.
 */
